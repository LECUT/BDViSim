  ...
  if(result4=='false')
  {
    ...
    if (!window.result4[id]) {
      ...
      for (var sp3 in result4[id]) {
        ...
        tdx = tdx + (Number(result4[id][sp3][0])/1000).toFixed(6) + '\n'
        tdy = tdy + (Number(result4[id][sp3][1])/1000).toFixed(6) + '\n'
        tdz = tdz + (Number(result4[id][sp3][2])/1000).toFixed(6) + '\n'
        tdg = tdg + (Number(result4[id][sp3][3])/1000).toFixed(6) + '\n'
...
function neworbitcal() {
  ...
  for (var i = 0; i <(((60/tstep))*24+1); i++) {
    ...
    if (i == 0) {
      text1.value = fix("time", 15);
      if (c1.checked == true) {
        text1.value = text1.value + fix("X(TLE)", 22) + "\t" + fix("Y(TLE)", 22) + "\t" + fix("Z(TLE)", 22) + "\t";
      }
      if (c4.checked == true) {
        text1.value = text1.value + fix("X(YUMA)", 22) + "\t" + fix("Y(YUMA)", 22) + "\t" + fix("Z(YUMA)", 22) + "\t";
      }
      if (c2.checked == true) {
        text1.value = text1.value + fix("X(Rinex)", 22) + "\t" + fix("Y(Rinex)", 22) + "\t" + fix("Z(Rinex)", 22) + "\t";
      }
      if (c3.checked == true) {
        text1.value = text1.value + fix("X(SP3)", 22) + "\t" + fix("Y(SP3)", 22) + "\t" + fix("Z(SP3)", 22) + "\t";
      }
      ...
      if (c2.checked == true) {
        ...
        if (!window.result3[id][timeid]) {
          ...
          text1.value = text1.value + fix(result3[id][timeid]["epoch"].replace("T", " "), 22) + "\t";
          if (c1.checked == true) {
            ...
            text1.value = text1.value +
              fix(result2[id][timeid]["x"], 22) + "\t" +
              fix(result2[id][timeid]["y"], 22) + "\t"
              + fix(result2[id][timeid]["z"], 22) + '\t';
          }
          data_x2.push(result3[id][timeid]['X_k']);
          data_y2.push(result3[id][timeid]['Y_k']);
          data_z2.push(result3[id][timeid]['Z_k']);
          text1.value = text1.value +
            fix(result3[id][timeid]['X_k'], 22) + '\t' +
            fix(result3[id][timeid]['Y_k'], 22) + '\t' +
            fix(result3[id][timeid]['Z_k'], 22) + "\t";
          if (c3.checked == true) {
            ...
            text1.value = text1.value + fix(result4[id][timeid][0], 22) + '\t' +
              fix(result4[id][timeid][1], 22) + '\t' +
              fix(result4[id][timeid][2], 22) + "\t";
          ...
          if (c4.checked == true) {
            ...
            text1.value = text1.value + fix(result5[id][timeid].X_k, 22) + "\t" +
              fix(result5[id][timeid].Y_k, 22) + "\t" +
              fix(result5[id][timeid].Z_k, 22)
          }
        ...
        if (c1.checked == true) {
          ...
          text1.value = text1.value + fix(result2[id][timeid]["time"].replace("T", " "), 22) + "\t";
          data_x1.push(result2[id][timeid].x);
          data_y1.push(result2[id][timeid].y);
          data_z1.push(result2[id][timeid].z);
          text1.value = text1.value +
            fix(result2[id][timeid].x, 22) + "\t" + fix(result2[id][timeid].y, 22) + "\t"
            + fix(result2[id][timeid].z, 22) + '\t';
        }
        ...
        if (c3.checked == true) {
          ...
          if (c1.checked != true) {
            text1.value = text1.value + fix(result4[id][timeid][4].replace("T", " "), 22) + "\t";
          }
          data_x3.push(result4[id][timeid][0]);
          data_y3.push(result4[id][timeid][1]);
          data_z3.push(result4[id][timeid][2]);
        ...
        if (c4.checked == true) {
          ...
          if (timelist.length == i - 1) {
            ...
            timelist.push(result4[id][timeid][4].slice(11, 16));
            text1.value = text1.value + fix(result5[id][timeid]['epoch'].replace("T", " "), 22) + "\t";
          }
          data_x4.push(result5[id][timeid].X_k);
          data_y4.push(result5[id][timeid].Y_k);
          data_z4.push(result5[id][timeid].Z_k);
